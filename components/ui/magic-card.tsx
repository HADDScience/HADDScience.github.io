...
export function MagicCard(props: MagicCardProps) {
  ...
  // 이 사이트는 라이트 모드로 고정이다(components/theme-provider.tsx 참고).
  // 원본 컴포넌트는 next-themes 로 다크 여부를 감지해 orb 모드의 blend mode 를
  // 바꾸지만, 그 감지가 effect 안에서 setState 를 호출해 lint 규칙에 걸린다.
  // 테마가 고정이므로 상수로 대체했다. 다크 모드를 켤 때 원본 로직을 되살릴 것.
