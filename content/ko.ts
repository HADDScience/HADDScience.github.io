      ...
      sections: [
        {
          ...
          paragraphs: [
            "회사가 이 사이트에서 개인정보를 받는 곳은 문의하기 양식 한 곳입니다. 회원가입 절차와 결제 기능이 없으며, 그 밖의 경로로 이용자의 개인정보를 모으지 않습니다.",
          ],
          table: {
        ...
        },
        {
          ...
          list: [
            ...
            "이용자는 개인정보의 국외 이전을 거부할 수 있습니다. 거부하려면 문의 양식 대신 아래 '9. 문의처'의 전화나 이메일을 이용해 주십시오.",
        ...
        },
        {
          ...
          paragraphs: [
            "이용자는 언제든지 자신의 개인정보에 대해 열람, 정정, 삭제, 처리정지를 요구할 수 있습니다. 아래 '9. 문의처'로 연락하시면 회사는 지체 없이 조치하고 그 결과를 알려 드립니다.",
        ...
        },
        {
          ...
          list: [
            ...
            "이 사이트는 이용자를 추적하거나 광고를 위한 쿠키·분석 도구를 사용하지 않습니다. 화면 테마(밝게·어둡게) 설정만 이용자의 브라우저에 저장되며, 이 값은 회사 서버로 전송되지 않습니다.",
          ],
        },
        {
