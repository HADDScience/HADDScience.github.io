      ...
      <Section>
        <Container>
          <div className="grid gap-10 md:grid-cols-[1fr_1.2fr]">
            <h2 className="text-3xl font-extrabold tracking-[-0.03em] text-balance text-brand-blue-700 md:text-4xl">
              {a.headline}
            </h2>
        ...
        <Container>
          <div className="grid items-center gap-10 md:grid-cols-[1.2fr_1fr]">
            <div className="grid gap-5">
              ...
              <p className="text-2xl font-bold text-balance text-brand-blue-700 md:text-3xl">
                “{a.team.quote}”
              </p>
            </div>
            <div className="md:justify-self-end">
              <Button
                nativeButton={false}
                size="lg"
                render={<Link href={path("/about/team")} />}
              >
                {a.team.cta}
              </Button>
            </div>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {a.culture.values.map((value, i) => (
              <SurfaceCard key={value} className="grid gap-4 p-8">
                <span className="font-mono text-sm font-bold text-brand-orange-500">
